...
+ (NSArray *)defaultEmotions
{
    if (!_defaultEmotions) {
        ...
        _defaultEmotions = [MQEmotion objectArrayWithFile:plist];
...
+ (NSArray *)emojiEmotions
{
    if (!_emojiEmotions) {
        ...
        _emojiEmotions = [MQEmotion objectArrayWithFile:plist];
...
+ (NSArray *)lxhEmotions
{
    if (!_lxhEmotions) {
        ...
        _lxhEmotions = [MQEmotion objectArrayWithFile:plist];
